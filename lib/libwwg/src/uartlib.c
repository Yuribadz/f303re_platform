...
static struct s_uart_info uarts[3] = {
	{ USART1, RCC_USART1, NVIC_USART1_EXTI25_IRQ, uart1_getc, uart1_putc },
	{ USART2, RCC_USART2, NVIC_USART2_EXTI26_IRQ, uart2_getc, uart2_putc },
	{ USART3, RCC_USART3, NVIC_USART3_EXTI28_IRQ, uart3_getc, uart3_putc }
};
...
static void
uart_common_isr(unsigned  __attribute__((unused))ux) {
#ifndef STM32F3
...
putc_uart_nb(uint32_t uartno,char ch) {
	...
	if ( (USART_ISR(uart) & USART_ISR_TXE) == 0 )
		return -1;	/* Busy */
